...
#
# _Authored by Claude Code_ - 2026-09-12, from verification-demo-plan.md.
#
...
# Promote the current run as the demo-day fallback.
fixture:
...
# Demo-day rehearsal: same pipeline with the containers cut off the network.
