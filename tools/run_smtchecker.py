...
The Horn solver is Eldarica, not z3, which is the one substantive deviation
from the plan. No official solc binary ships a Horn solver: 0.7.6, 0.8.26 and
...
# Captured from the Phase 0 spike against solc 0.8.26 + Eldarica 2.3. The
